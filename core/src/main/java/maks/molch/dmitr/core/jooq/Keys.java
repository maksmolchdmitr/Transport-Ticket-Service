...
public class Keys {
    ...
    public static final UniqueKey<PurchasedTicketsRecord> CONSTRAINT_F = Internal.createUniqueKey(PurchasedTickets.PURCHASED_TICKETS, DSL.name("CONSTRAINT_F"), new TableField[]{PurchasedTickets.PURCHASED_TICKETS.ID}, true);
    public static final UniqueKey<PurchasedTicketsRecord> CONSTRAINT_F16B = Internal.createUniqueKey(PurchasedTickets.PURCHASED_TICKETS, DSL.name("CONSTRAINT_F16B"), new TableField[]{PurchasedTickets.PURCHASED_TICKETS.USER_LOGIN, PurchasedTickets.PURCHASED_TICKETS.TICKET_ID}, true);
    ...
    public static final ForeignKey<PurchasedTicketsRecord, UserTableRecord> CONSTRAINT_F1 = Internal.createForeignKey(PurchasedTickets.PURCHASED_TICKETS, DSL.name("CONSTRAINT_F1"), new TableField[]{PurchasedTickets.PURCHASED_TICKETS.USER_LOGIN}, Keys.CONSTRAINT_C, new TableField[]{UserTable.USER_TABLE.LOGIN}, true);
    public static final ForeignKey<PurchasedTicketsRecord, TicketTableRecord> CONSTRAINT_F16 = Internal.createForeignKey(PurchasedTickets.PURCHASED_TICKETS, DSL.name("CONSTRAINT_F16"), new TableField[]{PurchasedTickets.PURCHASED_TICKETS.TICKET_ID}, Keys.CONSTRAINT_5, new TableField[]{TicketTable.TICKET_TABLE.ID}, true);

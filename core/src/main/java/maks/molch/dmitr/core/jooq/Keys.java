...
public class Keys {
    ...
    public static final ForeignKey<TicketTableRecord, UserTableRecord> CONSTRAINT_5C = Internal.createForeignKey(TicketTable.TICKET_TABLE, DSL.name("CONSTRAINT_5C"), new TableField[] { TicketTable.TICKET_TABLE.USER_LOGIN }, Keys.CONSTRAINT_C, new TableField[] { UserTable.USER_TABLE.LOGIN }, true);
}

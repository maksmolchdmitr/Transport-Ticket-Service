...
public class TicketTable extends TableImpl<TicketTableRecord> {
    ...
    /**
     * The column <code>TICKET_TABLE.USER_LOGIN</code>.
     */
    public final TableField<TicketTableRecord, String> USER_LOGIN = createField(DSL.name("USER_LOGIN"), SQLDataType.VARCHAR(32).nullable(false), this, "");
    ...
    public List<ForeignKey<TicketTableRecord, ?>> getReferences() {
        return Arrays.asList(Keys.CONSTRAINT_5, Keys.CONSTRAINT_5C);
    }
    ...
    public UserTablePath userTable() {
        if (_userTable == null)
            _userTable = new UserTablePath(this, Keys.CONSTRAINT_5C, null);
